                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guard('web_admin')->guest())
                            ...
                            <!--Admin/Staff Login and registration Links -->
                            <li><a href="{{ url('/') }}"><strong>Home</strong></a></li>
                            @if(Request::is('admin_login'))
                            
                                <li><a href="{{ url('/admin_register') }}"><strong>Staff Registration</strong></a></li>

                            @elseif(Request::is('admin_register'))

                                <li><a href="{{ url('/admin_login') }}"><strong>Staff Login</strong></a></li>
